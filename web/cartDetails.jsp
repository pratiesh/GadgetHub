...
<%@page import="in.gadgethub.dao.*,in.gadgethub.pojo.*,javax.servlet.ServletOutputStream,java.io.*,java.util.*" %>
<!DOCTYPE html> 
<html> 
<head> 
  ...
  <table class="table table-hover"> 
   ...
   <tbody> 
    ...
    <tr> 
     ...
     <td><a 
      href="CartDetailsServlet?add=0&uid=<%=username %>&pid=<%=prodId %>&avail=<%=product.getProdQuantity() %>&qty=<%=prodQuantity %>"><i 
