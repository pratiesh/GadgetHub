    ...
    <div class="container-fluid bg-primary text-white p-2">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <p>
              <i class="fa-solid fa-phone"></i> Phone : +91899895621
            </p>
            <p>
              <i class="fa-solid fa-envelope"></i> Email : pratikraw04@gmail.com  
            </p>
            <p>
              <i class="fa-solid fa-signs-post"></i> Postal Code : 462038
            </p>
          </div>
          <div class="col-md-8">
            <form action="#">
