                ...
                <form action="./UpdateProductServlet" method="post" class="col-md-6 col-md-offset-3 myform"> 
                    <div class="text-center"> 
                        <div class="form-group"> 
                            <img src="./ShowImageServlet?pid=<%=product.getProdId()%>" alt="Product Image" height="100"/> 
                    ...
                    <div class="row"> 
                        <input type="hidden" name="pid" class="form-control" value="<%=product.getProdId()%>" id="last_name"> 
                    </div> 
